...
::accordion
  ...
  - **CLI Tools:** bat, bottom, broot, curl, duf, dust, fastfetch, fx, gum, htmlq, htop, hyperfine, jq, lnav, make, oha, pandoc, ripgrep, sd, shellcheck, tealdeer, tokei, tree, viddy, xh, yamlfmt, yazi, yq, zoxide
  :::
