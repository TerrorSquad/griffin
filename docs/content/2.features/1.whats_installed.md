...
=======
  - **CLI Tools:** bat, bottom, broot, curl, duf, dust, fastfetch, fx, htop, hyperfine, jq, lnav, make, oha, ripgrep, sd, shellcheck, tealdeer, tokei, tree, viddy, xh, yamlfmt, yazi, yq, zoxide
>>>>>>> adbd3c7 (chore: drop python cli tools, promote rust ones)
  :::
...
=======
  - **Networking Tools:** curl, gping, xh
...
<<<<<<< HEAD
  - **Linux Utilities:** Bleachbit, Redshift, Variety, Papirus Theme, Adapta Themes, input-remapper, Unified Remote :badge[`all` only]{color="secondary"}
  - **Monitoring & File Mgmt:** btop, htop, procs, duf, dust, eza, fd, fzf, lsd, ncdu
=======
  - **Linux Utilities:** Bleachbit, Redshift, Variety, Papirus Theme, Adapta Themes, Unified Remote, input-remapper
  - **Monitoring & File Mgmt:** btop, htop, procs, duf, dust, eza, fd, fzf, ncdu
>>>>>>> adbd3c7 (chore: drop python cli tools, promote rust ones)
  :::
